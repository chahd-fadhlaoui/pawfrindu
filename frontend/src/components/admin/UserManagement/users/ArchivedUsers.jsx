...
const ArchivedUsers = ({ showHeader = true }) => {
        ...
        <div className="overflow-hidden bg-white shadow-lg rounded-xl animate-fadeIn">
          ...
          >
            <div className="flex items-center flex-1">
              ...
              <div className="ml-4">
                <h2 className="text-lg font-bold text-gray-900 sm:text-xl">Archived Users</h2>
                <p className="text-sm text-gray-500">Manage archived user accounts</p>
              </div>
            </div>
