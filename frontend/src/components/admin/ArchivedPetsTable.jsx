    ...
    return (
      <div className="w-full p-8 bg-red-50 border-2 border-red-200 rounded-xl">
        <p className="text-red-600 text-center font-medium">
          Error loading archived pets: {error}
        </p>
      </div>
    );
  }
            ...
            <tbody className="divide-y divide-rose-100">
              {pets.map((pet) => (
                ...
                >
                  ...
                  <td className="px-4 py-4">
                    <div className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-gradient-to-r from-gray-100 to-gray-200 border border-gray-300">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="w-full bg-rose-50 p-4 rounded-xl border border-rose-200">
                <div className="grid grid-cols-2 gap-4 text-gray-700">
                  <p>
                    <span className="font-semibold text-rose-600">Breed:</span>{" "}
                    {selectedPet.breed}
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="font-semibold text-rose-600">City:</span>{" "}
                    {selectedPet.city}
                  </p>
                  <p>
