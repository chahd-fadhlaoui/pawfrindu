        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <input
                type="tel"
                value={formData.trainerDetails.secondaryPhone || ""}
                onChange={(e) => handleInputChange("trainerDetails", "secondaryPhone", e.target.value)}
                className="w-full bg-transparent focus:outline-none"
                placeholder="58123456"
                pattern="[0-9]*"
                maxLength={8}
          ...
          {["Arabic", "French", "English"].map((lang) => (
            <div
              ...
              className={`flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer ${animationClass} ${
                formData.trainerDetails.languagesSpoken.includes(lang)
              ...
              tabIndex={0}
              role="checkbox"
              aria-checked={formData.trainerDetails.languagesSpoken.includes(lang)}
            >
