  ...
  const renderStep1 = () => (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="flex flex-col items-center justify-center mb-6">
        <div className="relative">
          <img
            ...
            alt="Profile preview"
            className="object-cover w-40 h-40 rounded-full border-2 border-[#ffc929] mb-4 shadow-md"
          />
          <label className="absolute -bottom-2 right-0 px-3 py-1 text-xs font-medium text-white bg-teal-600 rounded-full hover:bg-teal-700 cursor-pointer shadow-md transition-all duration-200">
      ...
      <div className="space-y-5">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Languages Spoken <span className="text-red-500">*</span></label>
          ...
          {formErrors.languagesSpoken && <p className="text-sm text-red-500 mt-1">{formErrors.languagesSpoken}</p>}
        </div>
        <div>
        ...
        <div className="mt-2 flex justify-between items-center">
          <div>
            <p className="text-sm text-gray-700">
              Latitude:{" "}
              {formData.veterinarianDetails.geolocation?.latitude ?? "Not set"}
            </p>
            <p className="text-sm text-gray-700">
              Longitude:{" "}
              {formData.veterinarianDetails.geolocation?.longitude ?? "Not set"}
            </p>
          </div>
          <button
            type="button"
            onClick={getCurrentLocation}
            className="px-4 py-2 text-sm font-medium text-white bg-teal-600 rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors flex items-center"
          >
            <svg
    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="space-y-6">
        ...
        <button
          ...
          className="w-full px-6 py-3 text-base font-medium text-white bg-teal-600 rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
