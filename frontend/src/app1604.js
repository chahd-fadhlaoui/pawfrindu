...
import MyVetappointments from './pages/VetAppointment/MyVetappointments';
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/Vetappointments" element={<ProtectedRoute allowedRoles={["PetOwner"]}><MyVetappointments /></ProtectedRoute>} /> {/* New standalone route */}
