...
export default function PetFinderForm() {
  ...
  useEffect(() => {
    socket.on("foundReportCreated", (data) => {
      console.log("New found report created:", data);
    });
  ...
  const validateSection = (sectionIndex) => {
    ...
    if (sectionIndex === 0) {
      ...
      if (!formData.timeKnown && !formData.timeOfDay) {
        errors.timeOfDay =
          "Approximate time is required if exact time is not known";
      }
    } else if (sectionIndex === 3) {
      if (!isAuthenticated && (!formData.email || !formData.phoneNumber)) {
        errors.contact =
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(errors).length > 0) {
      ...
      const firstErrorSection = Math.min(
        errors.species ? 0 : Infinity,
        errors.colors || errors.photos ? 1 : Infinity,
        errors.governorate ||
          errors.delegation ||
          errors.date ||
          errors.exactTime ||
    ...
    const dataToSend = {
      ...
      colorType: formData.colorType || undefined,
      ...
      microchipNumber:
        formData.microchipChecked && formData.microchipNumber
          ? formData.microchipNumber
          : undefined,
      status: "Pending",
      owner: isAuthenticated && user?._id ? user._id : undefined,
      email: isAuthenticated ? undefined : formData.email,
      phoneNumber: isAuthenticated ? undefined : formData.phoneNumber,
    };
    ...
    console.log("Data to send:", JSON.stringify(dataToSend, null, 2)); // Debug log
      ...
      <div className="max-w-4xl p-6 pt-16 mx-auto md:pt-24">
        <div className="mb-12 text-center">
          ...
          <p className="max-w-2xl mx-auto mt-6 text-lg leading-relaxed text-gray-600">
            Help reunite a lost pet with their worried family by submitting details about the pet you've found.
          </p>
        </div>
        ...
        >
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="p-6 border border-[#ffc929]/20 rounded-xl bg-white">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          handleInputChange("isPregnant", null, false);
                        }}
                  ...
                  <div className="space-y-2">
                    <Tooltip text="Select the breed of the pet, if known (optional)">
                      <label
                        htmlFor="breed"
                        className="flex items-center gap-1 text-sm font-medium text-gray-700"
                      >
                    ...
                    <p id="breed-hint" className="text-xs text-gray-500">
                      Breed is optional
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2">
                  <div className="space-y-2">
                    <Tooltip text="Select the approximate size of the pet (optional)">
                      <label
                        htmlFor="size"
                        className="flex items-center gap-1 text-sm font-medium text-gray-700"
                      >
                    ...
                    <p id="size-hint" className="text-xs text-gray-500">
                      Size is optional
                    </p>
                  </div>
                  <div className="space-y-2">
                    <Tooltip text="Select the gender of the pet (optional)">
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="flex justify-between mt-8">
                ...
                <button
                  ...
                  onClick={nextSection}
                  className={`px-6 py-3 font-medium text-white bg-gradient-to-r from-[#ffc929] to-[#ffa726] rounded-xl hover:shadow-lg flex items-center gap-2 ${animationClass} disabled:opacity-50 disabled:cursor-not-allowed`}
                  disabled={!!formErrors.colors || !!formErrors.photos}
                >
                  Next <span className="text-xl">→</span>
                </button>
              </div>
          ...
          {activeTab === 2 && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="p-6 border border-[#ffc929]/20 rounded-xl bg-white">
                <div className="space-y-4">
                  <Tooltip text="Pinpoint the exact location where the pet was found">
                    <label className="flex items-center gap-1 text-sm font-medium text-gray-700">
                  ...
                  <div className="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <Tooltip text="Select the governorate where the pet was found">
                        <label
                          htmlFor="governorate"
                          className="flex items-center gap-1 text-sm font-medium text-gray-700"
                        >
                ...
                <div className="mt-8 space-y-4">
                  <Tooltip text="Specify the date and time when the pet was found">
                    <label className="flex items-center gap-1 text-sm font-medium text-gray-700">
                      When was the pet found?{" "}
                      <span className="text-red-500">*</span>
                      <Info size={14} className="text-gray-400" />
                    </label>
                  </Tooltip>
          ...
          {activeTab === 3 && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="p-6 border border-[#ffc929]/20 rounded-xl bg-white">
                <div className="space-y-4">
                  <Tooltip text="Check if the pet has a microchip and provide the number if found">
                    <label className="flex items-center gap-1 text-sm font-medium text-gray-700">
                      Microchip Information
                      <Info size={14} className="text-gray-400" />
                    </label>
                  </Tooltip>
                  <div className="p-4 border border-[#ffc929]/30 rounded-xl bg-[#ffc929]/10">
                    <label className="flex items-center mb-4">
                      <input
                        type="checkbox"
                        checked={formData.microchipChecked}
                        onChange={() =>
                          handleInputChange(
                            "microchipChecked",
                            null,
                            !formData.microchipChecked
                          )
                        }
                        className="w-5 h-5 text-[#ffc929] border-gray-300 rounded focus:ring-[#ffc929]"
                      />
                      <span className="ml-2 text-gray-700">
                        Pet has been scanned for microchip
                      </span>
                    </label>
                    {formData.microchipChecked ? (
                      <input
                        ...
                        placeholder="Enter microchip number (if found)"
                        className={`w-full p-3 text-gray-700 bg-white border-2 rounded-xl focus:border-[#ffc929] focus:ring-2 focus:ring-[#ffc929]/30 ${animationClass} border-[#ffc929]/30`}
                      />
                    ) : (
                      <div className="flex p-3 text-sm text-gray-600 bg-white rounded-lg">
                        <Info
                          size={18}
                          className="mr-2 text-[#ffc929] shrink-0"
                        />
                        <p>
                          Consider taking the pet to a nearby veterinarian or
                          animal shelter to scan for a microchip.
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <div className="mt-6 space-y-2">
                  <Tooltip text="Provide any additional details about the pet (e.g., behavior, collar)">
                    <label className="flex items-center gap-1 text-sm font-medium text-gray-700">
                  ...
                  <textarea
                    ...
                    placeholder="Provide any additional details about the pet (behavior, distinguishing features, collar type, etc.)"
                    rows={4}
                    className={`w-full p-4 text-gray-700 bg-white border-2 rounded-xl focus:border-[#ffc929] focus:ring-2 focus:ring-[#ffc929]/30 ${animationClass} border-[#ffc929]/30`}
                  />
                </div>
                <div className="mt-6 space-y-2">
                  <Tooltip
                    text={
                      isAuthenticated
                        ? "Your contact details are taken from your profile"
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div className="relative">
                        <input
                          ...
                          aria-describedby={
                            formErrors.contact ? "contact-error" : undefined
                          }
                        />
                        {formErrors.contact && !formData.email && (
                          <span className="absolute top-0 right-0 px-2 py-1 text-xs font-medium text-red-500 rounded-bl bg-red-50">
                      ...
                      <div className="relative">
                        <input
                          ...
                          pattern="[0-9]{8,15}"
                          className={`w-full p-3 text-gray-700 bg-white border-2 rounded-xl focus:border-[#ffc929] focus:ring-2 focus:ring-[#ffc929]/30 ${animationClass} ${
                            formErrors.contact && !formData.phoneNumber
                              ? "border-red-500 bg-red-50/30 ring-2 ring-red-200"
                              : "border-[#ffc929]/30"
                          }`}
                          aria-describedby={
              ...
              <div className="flex justify-between mt-8">
                ...
                <button
                  ...
                  disabled={
                    isSubmitting ||
                    (!isAuthenticated && (!formData.email || !formData.phoneNumber))
                  }
        ...
        <div className="mt-8 text-center text-gray-500">
          <p>Thank you for helping reunite lost pets with their families.</p>
        </div>
      </div>
    </div>
  );
